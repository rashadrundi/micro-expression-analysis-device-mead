...
# Installation
<<<<<<< HEAD
This project runs on Python 3.12.12, running on any version after may cause unwanted issues. Ensure that all execution and installation is done in an environment with 3.12.12. To clone the repository run:
´´´
=======
...
```
>>>>>>> f80245d0d763f4c5cd705f891e6dacfe8a2273cd
